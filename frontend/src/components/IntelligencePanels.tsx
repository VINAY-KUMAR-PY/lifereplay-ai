...
export function ScorecardPanel({ scorecard, compact = false }: { scorecard: DecisionScorecard; compact?: boolean }) {
  ...
  return (
    <div className="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-2"><span className="rounded-md bg-emerald-50 px-3 py-2 text-xs font-black text-emerald-800">Strongest: {strongest[1]} {scorecard[strongest[0]]}</span><span className="rounded-md bg-amber-50 px-3 py-2 text-xs font-black text-amber-800">Weakest: {weakest[1]} {scorecard[weakest[0]]}</span></div>
